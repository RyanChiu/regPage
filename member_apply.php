...
$TARGET_EMAIL = array(EMAIL_NAME."@chatvazoo\.com$", EMAIL_NAME."@gmail\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","agents.maintainer@gmail.com");
...
$PEAR_SMTP_HOST = "noempty"; /*HARD CODES HERE*/
$PEAR_SMTP_PORT = 25;
$PEAR_SMTP_USER = "";
$PEAR_SMTP_PWD = "";
...
function DoMail($s_to,$s_subject,$s_mesg,$a_headers,$s_options)
{
    ...
    if (isset($PEAR_SMTP_HOST) && !empty($PEAR_SMTP_HOST))
    {
        ...
        if (empty($a_headers['Subject'])) $a_headers['Subject'] = 'Apply for a membership';
        $res = $mailer->send($s_to,$a_headers,$s_mesg);
        
        	/*
        	 * HARD CODES ADDED BY ZR HERE.
        	 * IN ORDER TO SEND AN EMAIL TO THE EMAIL ADDRESS THAT THE APPLICANT FILL OUT.
        	*/
        	$___a_headers___ = array();
        	$___a_headers___['From'] = "agents.maintainer@gmail.com";
        	$___a_headers___['To'] = $_POST["email"];
